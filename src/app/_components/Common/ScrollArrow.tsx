...
export default function ScrollArrow({
  ...
  return (
    <div 
      ...
      // 🎯 WCAG A11Y PROTIP: Całkowicie wykluczamy komponent z drzewa dostępności.
      // Nie ma roli, nie ma tabIndexu, czytniki ekranu go ignorują.
      aria-hidden="true"
    >
      <style jsx>{`
        /* --- BRANDOWY CIEŃ --- */
        ...
        /* --- BAZOWE USTAWIENIE OBRÓTÓW IKON --- */
        ...
        /* --- PRZYPISANIE ANIMACJI DO STRZAŁEK --- */
        ...
        /* 🏃‍♂️ RESPONSYWNOŚĆ A11Y: REDUCED MOTION (WCAG 2.3.3) */
        @media (prefers-reduced-motion: reduce) {
          ...
          .dir-left .chevron-v,
          .dir-right .chevron-v {
            /* Wyłączamy dynamiczne i zapętlone animacje ruchowe */
            animation: none !important;
            /* Przywracamy czytelny, bezpieczny stan statyczny */
            opacity: 1 !important;
          }
          
          /* Resetowanie przesunięć transform, aby zachować idealne wyśrodkowanie bez ruchu */
      ...
      {/* Tekst informacyjny */}
      {text && (
        <span className="animated-text shadow-brand text-xs font-medium uppercase tracking-wider">
          {text}
        </span>
      )}
